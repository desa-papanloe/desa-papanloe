{{-- resources/views/admin/berita/index.blade.php - CLEANED VERSION (NO IMAGE FEATURES) --}}
<!DOCTYPE html>
...
<head>
    ...
    <title>Kelola Berita - Admin Desa Papanloe</title>
...
<body class="admin-layout">
            ...
            <aside id="admin-sidebar" class="admin-sidebar">
                ...
                <nav class="sidebar-nav">
                    ...
                    <a href="{{ route('admin.berita.index') }}" class="nav-item active">
                        ...
                        <span class="nav-badge">{{ $stats['published'] ?? 0 }}</span>
                    </a>
                ...
                <main class="page-content">
                    ...
                    <div class="page-header">
                        <div class="header-content">
                            <div class="header-left">
                                <h1>📰 Kelola Berita</h1>
                                <p>Kelola berita dan informasi desa</p>
                            </div>
                            <div class="header-actions">
                                <button class="btn btn-secondary" onclick="importBerita()">
                                    📥 Import
                                </button>
                            ...
                            <div class="stat-card stat-green">
                                <div class="stat-content">
                                    <div>
                                        ...
                                        <div class="stat-desc">Sudah terbit</div>
                                    </div>
                                    <div class="stat-icon">✅</div>
                                </div>
                            </div>
                            ...
                            <div class="stat-card stat-orange">
                                <div class="stat-content">
                                    <div>
                                        ...
                                        <div class="stat-desc">Belum terbit</div>
                                    </div>
                                    <div class="stat-icon">📝</div>
                                </div>
                            </div>
                            ...
                            <div class="stat-card stat-yellow">
                                <div class="stat-content">
                                    <div>
                                        ...
                                        <div class="stat-desc">Berita utama</div>
                                    </div>
                                    <div class="stat-icon">⭐</div>
                                </div>
                            </div>
                            ...
                            <div class="stat-card stat-red">
                                <div class="stat-content">
                                    <div>
                                        ...
                                        <div class="stat-number">{{ $stats['archived'] ?? 0 }}</div>
                                        <div class="stat-desc">Diarsipkan</div>
                                    </div>
                                    <div class="stat-icon">📦</div>
                                </div>
                            </div>
                            ...
                            <div class="stat-card stat-purple">
                                <div class="stat-content">
                                    <div>
                                        ...
                                        <div class="stat-number">{{ $stats['bulan_ini'] ?? 0 }}</div>
                                        <div class="stat-desc">Berita baru</div>
                                    </div>
                                    <div class="stat-icon">📅</div>
                                </div>
                            </div>
                    ...
                    <div class="filters-section">
                        ...
                        <div class="filters-grid" id="filters-grid">
                            ...
                            <div class="filter-group">
                                ...
                                <select class="filter-input" id="filter-featured">
                            ...
                            <div class="filter-group">
                                ...
                                <input type="date" class="filter-input" id="filter-tanggal-dari">
                            </div>

                            <div class="filter-group">
                                <label class="filter-label">Tanggal Sampai</label>
                                <input type="date" class="filter-input" id="filter-tanggal-sampai">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="table-card">
                        <div class="table-header">
                            ...
                            <div class="table-actions">
                                <div class="search-box">
                                    ...
                                    <input type="text" class="search-input" placeholder="Cari berita..." id="global-search">
                                </div>
                        ...
                        <div class="table-container">
                            <table id="berita-table" class="display responsive nowrap" style="width:100%">
                                <thead>
                                    <tr>
                                        <th width="40">
                                            <input type="checkbox" id="select-all">
                                        </th>
                                        <th width="300">Berita</th>
                                        <th width="100">Kategori</th>
                                        <th width="80">Status</th>
                                        <th width="70">Views</th>
                                        <th width="120">Tanggal Terbit</th>
                    ...
                    <div id="bulk-actions" class="filters-section" style="display: none;">
                        <div class="filters-header">
                            ...
                            <span id="selected-count">0 berita dipilih</span>
                        </div>
                        <div style="display: flex; gap: 8px; flex-wrap: wrap;">
                            <button class="btn btn-secondary" onclick="bulkAction('publish')">
                                ✅ Publish
                            </button>
                            <button class="btn btn-secondary" onclick="bulkAction('draft')">
                                📝 Draft
                            </button>
    ...
    <script>
        ...
        function initializeDataTable() {
            beritaTable = $('#berita-table').DataTable({
                processing: true,
                serverSide: true,
                responsive: true,
                ...
                scrollCollapse: true,
                ajax: {
                    url: '{{ route("admin.berita.datatables") }}',
                    data: function(d) {
                ...
                columns: [
                    {
                        ...
                        render: function(data, type, row) {
                            return `<input type="checkbox" class="berita-checkbox" value="${data}">`;
                        }
                    },
                    {
                        data: 'judul',
                        ...
                        render: function(data, type, row) {
                            ...
                            let excerpt = row.excerpt ? 
                                (row.excerpt.length > 80 ? row.excerpt.substring(0, 80) + '...' : row.excerpt) : 
                                'Tidak ada ringkasan';
                            
                            return `
                                <div>
                                    <div style="font-weight: 600; color: #111827; margin-bottom: 2px; font-size: 12px;">${data.length > 50 ? data.substring(0, 50) + '...' : data}</div>
                    ...
                    },
                    {
                        ...
                        name: 'views',
                        render: function(data) {
                            return `<span class="text-gray-600 font-medium">${parseInt(data).toLocaleString()}</span>`;
                        }
                    },
                    {
                        data: 'published_at',
                        ...
                        render: function(data, type, row) {
                            if (data) {
                                const publishedDate = new Date(data);
                                const dateStr = publishedDate.toLocaleDateString('id-ID', {
                                    day: '2-digit',
                                    month: 'short',
                                    year: 'numeric'
                                });
                                const timeStr = publishedDate.toLocaleTimeString('id-ID', {
                                    hour: '2-digit',
                                    minute: '2-digit'
                                });
                        ...
                        render: function(data, type, row) {
                            return `
                                <div class="action-buttons">
                                    <a href="/admin/berita/${data}" class="action-btn btn-view" title="Lihat">👁️</a>
                                    <a href="/admin/berita/${data}/preview" class="action-btn btn-preview" title="Preview" target="_blank">🔍</a>
                                    <a href="/admin/berita/${data}/edit" class="action-btn btn-edit" title="Edit">✏️</a>
                                    <button onclick="deleteBerita('${data}')" class="action-btn btn-delete" title="Hapus">🗑️</button>
                                </div>
                            `;
                        }
                    }
        ...
        function initializeFilters() {
            $('#filter-status, #filter-kategori, #filter-featured, #filter-tanggal-dari, #filter-tanggal-sampai').on('change', function() {
        ...
        function initializeEvents() {
            $('#select-all').on('change', function() {
                ...
                $('.berita-checkbox').prop('checked', isChecked);
                updateSelectedItems();
            });
        }

        function initializeCheckboxEvents() {
            $('.berita-checkbox').off('change').on('change', function() {
                updateSelectedItems();
                
                const totalCheckboxes = $('.berita-checkbox').length;
                const checkedCheckboxes = $('.berita-checkbox:checked').length;
        ...
        function updateSelectedItems() {
            selectedItems = [];
            $('.berita-checkbox:checked').each(function() {
        ...
        function updateSelectedCount() {
            $('#selected-count').text(`${selectedItems.length} berita dipilih`);
        }
        ...
        function toggleFeatured(id, featured) {
            ...
            $.ajax({
                url: `/admin/berita/${id}/toggle-featured`,
                type: 'POST',
                data: {
                    featured: featured,
                    _token: '{{ csrf_token() }}'
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        if (response.status === 'success') {
                            ...
                            showNotification('❌ ' + (response.message || 'Gagal menghapus berita'), 'error');
                        }
                    },
                    error: function(xhr, status, error) {
                        showNotification('❌ Gagal menghapus berita: ' + error, 'error');
                    }
                });
            }
        }
        ...
        function bulkAction(action) {
            if (selectedItems.length === 0) {
                showNotification('⚠️ Pilih minimal satu berita!', 'warning');
                return;
            }
            ...
            switch(action) {
                case 'publish':
                    confirmMessage = `Publish ${selectedItems.length} berita terpilih?`;
                    url = '/admin/berita/bulk-action';
                    break;
                case 'draft':
                    confirmMessage = `Jadikan draft ${selectedItems.length} berita terpilih?`;
                    url = '/admin/berita/bulk-action';
                    break;
                case 'archive':
                    confirmMessage = `Archive ${selectedItems.length} berita terpilih?`;
                    url = '/admin/berita/bulk-action';
                    break;
                case 'delete':
                    confirmMessage = `❌ HAPUS ${selectedItems.length} berita terpilih?\n\nData yang dihapus tidak dapat dikembalikan!`;
                    url = '/admin/berita/bulk-action';
                    break;
                case 'export':
            ...
            if (confirm(confirmMessage)) {
                ...
                .done(function(response) {
                    if (response.status === 'success') {
                        ...
                        beritaTable.ajax.reload();
                        selectedItems = [];
                        $('.berita-checkbox, #select-all').prop('checked', false);
                        toggleBulkActions();
                    } else {
